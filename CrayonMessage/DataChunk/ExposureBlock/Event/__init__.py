...
def ingest( event, football, device_id=None, block_uuid=None ):
    ...
    if not football.insert_event( basics, device_id=device_id, block_uuid=block_uuid, pixels=pixels, byteblock=byteblock, zerobias=zerobias ):
